...
Es la imagen que no posee una etiqueta, que se crea cuando creamos una imagen con el mismo nombre y etiqueta, lo que provoca que la anterior se quede sin etiqueta.# COMPLETAR CON LA RESPUESTA
